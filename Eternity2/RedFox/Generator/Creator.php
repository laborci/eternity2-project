...
class Creator {
	...
	protected function selectRedfoxField($db_field, $fieldName) {
		...
		if ($db_field['Comment'] == 'password') return 'Eternity2\RedFox\Fields\PasswordField';
		if ($db_field['Comment'] == 'json') return 'Eternity2\RedFox\Fields\JsonStringField';

		if ($dbtype == 'tinyint(1)') return 'Eternity2\RedFox\Fields\BoolField';
		if ($dbtype == 'date') return 'Eternity2\RedFox\Fields\DateField';
		if ($dbtype == 'datetime') return 'Eternity2\RedFox\Fields\DateTimeField';
		if ($dbtype == 'float') return 'Eternity2\RedFox\Fields\FloatField';

		if (strpos($dbtype, 'int(11) unsigned') === 0 && (substr($fieldName, -2) == 'Id' || $fieldName == 'id')) return 'Eternity2\RedFox\Fields\IdField';
		if (strpos($dbtype, 'int') === 0) return 'Eternity2\RedFox\Fields\IntegerField';
		if (strpos($dbtype, 'tinyint') === 0) return 'Eternity2\RedFox\Fields\IntegerField';
		if (strpos($dbtype, 'smallint') === 0) return 'Eternity2\RedFox\Fields\IntegerField';
		if (strpos($dbtype, 'mediumint') === 0) return 'Eternity2\RedFox\Fields\IntegerField';
		if (strpos($dbtype, 'bigint') === 0) return 'Eternity2\RedFox\Fields\IntegerField';

		if (strpos($dbtype, 'varchar') === 0) return 'Eternity2\RedFox\Fields\StringField';
		if (strpos($dbtype, 'char') === 0) return 'Eternity2\RedFox\Fields\StringField';
		if (strpos($dbtype, 'text') === 0) return 'Eternity2\RedFox\Fields\StringField';
		if (strpos($dbtype, 'text') === 0) return 'Eternity2\RedFox\Fields\StringField';
		if (strpos($dbtype, 'tinytext') === 0) return 'Eternity2\RedFox\Fields\StringField';
		if (strpos($dbtype, 'mediumtext') === 0) return 'Eternity2\RedFox\Fields\StringField';
		if (strpos($dbtype, 'longtext') === 0) return 'Eternity2\RedFox\Fields\StringField';

		if (strpos($dbtype, 'set') === 0) return 'Eternity2\RedFox\Fields\SetField';
		if (strpos($dbtype, 'enum') === 0) return 'Eternity2\RedFox\Fields\EnumField';
